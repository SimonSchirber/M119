...
BLEService myledService("78:BF:25:9B:35:52"); 
...
// }
void setState(BLEDevice central, BLECharacteristic myswitchCharacteristic){
  multiplier *= -1;
  float2byte(byteAy, multiplier);
  myswitchCharacteristic.writeValue(bytecomb, 4);
...
void setup() {
  ...
  myswitchCharacteristic.setEventHandler(BLERead, setState);
