#Pong game design used from from Tech with Tim at https://www.youtube.com/watch?v=vVGTZlnnX3U&t=345s
...
def main():
    ...
    while run:
        ...
        if won:
            text = SCORE_FONT.render(win_text)
            WIN.blit(WIDTH//2 - text.get_width()//2, HEIGHT//2 - text.get_height//2)
            pygame.display.update()
